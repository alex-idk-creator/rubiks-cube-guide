...
const notation = [
  ...
  { move: "x", title: "Перехват x", face: "cube", dir: "turn-cw", text: "Не крути слой. Возьми куб целиком и наклони его на себя: нижняя грань станет передней." },
  { move: "x'", title: "Перехват x'", face: "cube", dir: "turn-ccw", text: "Не крути слой. Возьми куб целиком и наклони от себя: верхняя грань станет передней." },
  { move: "y", title: "Перехват y", face: "cube", dir: "turn-cw", text: "Не крути верхний слой отдельно. Поверни куб целиком: правая грань станет передней." },
  { move: "y'", title: "Перехват y'", face: "cube", dir: "turn-ccw", text: "Не крути верхний слой отдельно. Поверни куб целиком: левая грань станет передней." },
  { move: "z", title: "Перехват z", face: "cube", dir: "turn-cw", text: "Не крути переднюю грань отдельно. Поверни куб целиком: верхняя грань уйдет вправо." },
  { move: "z'", title: "Перехват z'", face: "cube", dir: "turn-ccw", text: "Не крути переднюю грань отдельно. Поверни куб целиком: верхняя грань уйдет влево." },
];
...
function notationForToken(token) {
  ...
  const baseByMove = {
    ...
    x: { title: "Перехват x", face: "cube" },
    y: { title: "Перехват y", face: "cube" },
    z: { title: "Перехват z", face: "cube" },
  }[base];
...
function f2lPaintHint(listLength) {
  ...
  if (!listLength) return "Совпадений нет. Проверь, что ты поставил нужный слот спереди справа: возьми куб целиком в руках, не крути один верхний слой.";
...
function f2lPaintOrientationSvg() {
  ...
  return `
    <svg class="paint-orientation-svg" viewBox="0 0 300 238" role="img" aria-label="Как поставить F2L-слот для подбора: поставь куб в руках так, чтобы слот был спереди справа">
      <text x="150" y="22" text-anchor="middle" class="svg-note">перед раскраской переставь куб в руках</text>
      ${hSlot(92, 36, "сзади")}
...
function moveMeaning(token) {
  ...
  const map = {
    ...
    x: "перехват x: нижняя грань станет передней",
    "x'": "перехват x': верхняя грань станет передней",
    x2: "перехват x2: переверни куб вокруг правой-левой оси на 180°",
    y: "перехват y: правая грань станет передней",
    "y'": "перехват y': левая грань станет передней",
    y2: "перехват y2: задняя грань станет передней",
    z: "перехват z: верхняя грань уйдет вправо",
    "z'": "перехват z': верхняя грань уйдет влево",
    z2: "перехват z2: переверни куб вокруг передней-задней оси на 180°",
  ...
  return `
    <div class="f2l-painter">
      <div class="paint-intro">
        ...
        <p>Держи белый снизу, жёлтый сверху. Подбор работает в рабочем положении: возьми куб целиком в руках и поставь слот, который собираешь, спереди справа. Потом отметь два центра слота, белый угол и ребро пары; всё лишнее оставь серым.</p>
      </div>
      <div class="paint-workspace">
        ...
        <div class="paint-help">
          ...
          <ol>
            <li>Если слот сейчас слева или сзади, переставь куб в руках целиком; верхний слой отдельно не крути.</li>
